...
def fetch_transcript(video_id, language_code='ur'):
    """Fetches the transcript for a YouTube video in the specified language."""
    try:
...
language_code = st.selectbox("Select Transcript Language:", ["ur", "hi", "en"], index=0)
        ...
        if not video_id:
            ...
            if not title:
                ...
                with st.spinner("Fetching transcript..."):
                    transcript = fetch_transcript(video_id, language_code=language_code)
